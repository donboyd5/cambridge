...
ed_data <- acs_data |> 
  ...
  summarise(estimate = sum(estimate), .by=c(geoid, stabbr, trimname, trimname_base, geotype, edgroup)) |>
...
## Cambridge village college educational attainment is higher than in other area villages
