# Poverty in the general population
...
pov_data <- acs_data |> 
  ...
  select(stabbr, stname, geoid, geotype, geoname, trimname, trimname_base, variable, estimate) |> 
...
## Cambridge village poverty rate is higher than in other area villages
