...
# check <- acs_data  |> filter(stabbr=="NY", geotype=="state", table == "B07003")
...
mig_data <- acs_data |> 
  ...
  select(geoid, geotype, geoname, trimname, trimname_base, stabbr, variable, estimate) |> 
...
# set graph constants ----
barvar <- "moved_oocpct"
titlebase <- "Percent who moved to current house from out of county in the last year"
